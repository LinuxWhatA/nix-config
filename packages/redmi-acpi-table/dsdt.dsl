 ...
 *     Checksum         0xD6
 *     OEM ID           "XMCC  "
 *     OEM Table ID     "XMCC2108"
 *     OEM Revision     0x00000002 (2)
 *     Compiler ID      "ACPI"
 *     Compiler Version 0x00040000 (262144)
 */
DefinitionBlock ("", "DSDT", 1, "XMCC  ", "XMCC2108", 0x00000002)
{
    ...
    OperationRegion (MDBG, SystemMemory, 0x7AEB1018, 0x00001004)
    ...
    Scope (_SB.FUR1)
    {
        Device (UART)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, Buffer (0x22)
                {
                    /* 0000 */  0x8E, 0x1D, 0x00, 0x01, 0x00, 0x03, 0x02, 0x34,  // .......4
                    /* 0008 */  0x00, 0x01, 0x0A, 0x00, 0x00, 0xC2, 0x01, 0x00,  // ........
                    /* 0010 */  0x20, 0x00, 0x20, 0x00, 0x00, 0x00, 0x5C, 0x5F,  //  . ...\_
        ...
        Device (UART)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, Buffer (0x22)
                {
                    ...
                    /* 0008 */  0x00, 0x01, 0x0A, 0x00, 0x00, 0xC2, 0x01, 0x00,  // ........
                    /* 0010 */  0x20, 0x00, 0x20, 0x00, 0x00, 0xC0, 0x5C, 0x5F,  //  . ...\_
                    /* 0018 */  0x53, 0x42, 0x2E, 0x46, 0x55, 0x52, 0x32, 0x00,  // SB.FUR2.
                    /* 0020 */  0x79, 0x00                                       // y.
                })
        ...
        Device (UART)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, Buffer (0x22)
                {
                    ...
                    /* 0008 */  0x00, 0x01, 0x0A, 0x00, 0x00, 0xC2, 0x01, 0x00,  // ........
                    /* 0010 */  0x20, 0x00, 0x20, 0x00, 0x00, 0x00, 0x5C, 0x5F,  //  . ...\_
                    /* 0018 */  0x53, 0x42, 0x2E, 0x46, 0x55, 0x52, 0x33, 0x00,  // SB.FUR3.
                    /* 0020 */  0x79, 0x00                                       // y.
                })
        ...
        Device (UART)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, Buffer (0x22)
                {
                    ...
                    /* 0008 */  0x00, 0x01, 0x0A, 0x00, 0x00, 0xC2, 0x01, 0x00,  // ........
                    /* 0010 */  0x20, 0x00, 0x20, 0x00, 0x00, 0xC0, 0x5C, 0x5F,  //  . ...\_
                    /* 0018 */  0x53, 0x42, 0x2E, 0x46, 0x55, 0x52, 0x34, 0x00,  // SB.FUR4.
                    /* 0020 */  0x79, 0x00                                       // y.
                })
